...
<body>
  ...
  <script>
    ...
    const items = {
      Ores: ["Copper Ore : 400 each","Tin Ore : 400 each","Iron Ore : 800 each","Salt : 4k each","Coal : 3-4k each","Crimstell Ore : 3-4k each","Silver Ore : 4-5k each","Gold Ore : 3-4k each","Pink Salt : 8k each","Mythan Ore : 10-12k each","Sandstone : 10k each","Cobalt Ore : 12-14k each","Varaxium : 13-15k each","Black Salt : 10k each","Magic Ore : 4-4.5k each"],
      Bars: ["Copper Bar : 1k each","Iron Bar : 2k each","Steel Bar : 5k each","Crimsteel Bar : 20k each","Silver Bar : 25-30k each","Gold Nugget : 40k each","Gold Bar : 800k each","Mythan Bar : 150k each","Cobalt Bar : 120k each","Varax Bar : 160k each ","Magic Bar : 50-55kk each"],
      Logs: ["Pine Logs  : 1k each","Dead Logs : 2k each","Birch Logs : 3k each","Applewood : 2k each","Willow Logs : 5k each","Oak Logs : 4-5k each","Chestnut Logs : 7-8k each","Maple Logs : 7-8k each","Olive Logs : 11-12k each","Stinkwood : 8-9k each","Magic Log : 2.3k each","Palm Wood : 4k each","PearWood : 6-7k each","Lime Wood : 4-5k each"],
      Relics: ["Relic of Accuracy : 2-3k each","Relic of Guarding : 3k each","Relic of Healing : 4k each","Relic of Wealth : 3k each","Relic of Power : 5k each","Relic of Nature : 6k each","Relic of Fire : 8k each","Relic of Damage : 5k each","Relic of Leeching : 4-5k each","Relic of Experience : 11k each","Relic of Wisdom : 13k each ","Ice relic : 4k each","Cursed relic : 4k each","Relic of Efficiency : 4k each","Relic of Affliction : 4k each"],
      Fishes: ["Anchovies : each","Gold Fish : each","Mackerel : each","Squid : each","Sardine : each","Eel : each","Anglerfish : each","Trout : each","Jellyfish : each","Bass : each","Herringbone : each","Tuna : each","Lobster : each","Sea Turtle : each","Manta Ray : each","Shark : each","Orca : each","Giant Squid : each","Earthworm : each","Iceworm : each","Corpseworm : each","Toxicworm : each","Sandworm : each","Beetle : each","Grasshopper : each","Wasp : each","Scallop : each"],
      SpellBinding: ["Book : 2k each","Magic Essence : 600 each"],
      Alchemy: ["Bat Eye : each","Pink Gelatin : each","Fishing Spider Eye : each","Brown Mushroom : each","Forest Spider Eye : each","Cow Skull : each","Forest Bat Eye : each","Frozen Gelatin : each","Snow Core : each","Sapling Leaf : each","Ice Spider Eye : each","Cave Spider Eye : each","Skeletal Bat Eye : each","Sapphire Scarab Leg : each","Cave Bat Eye : each","Envenomed Blood : each","Raptor Claw : each","Ruby Scarab Leg : each","Forest Fiend Eye : each","Desert Raptor Claw : each","Rock Fiend Eye : each","Hornet Antena : each","Luminant Gelatin : each","Juvenile Eye : each","Ancient Bat Eye : each","Ice Raptor Claw : each","Spectral Flintstone  : each","Arocite Scarab Leg : each","Shadow Flintstone : each","Phantom Flintstone : each","Spectral Fiend Eye : each","Phantom Fiend Eye : each","Magnetite Scarab Leg : each","Corrupted Eye : each","Golemite Bat Eye : each","Golemite Fiend Eye : each","Tormented Eye : each","Disdain Eye : each","Baby Dragon Spine : each","Ragefull Eye : each"],
      Potions:["Potion : each","Mining Potion : each","Woodcutting Potion : each","Fishing Potion : each","Smithing Potion : each","Crafting Potion : each","Cooking Potion : each","Spellbinding Potion : each","Taskmaster's Brew : each","Prospector's Brew : each","Lumberjack's Ale : each","Blacksmith's Stout : each","Artisan's Syrup : each","Angler's Elixir : each","Chef's Kiss : each","Imbuer's Wine : each","Spellpower Potion : each","Concentrated Elixir : each","Divine Clarity : each","Titan's Strength : each","Duelist's Draft : each","Stonebound Salve : each","Backlash Balm : each","Berserker Potion : each","Arcanist's Wrath : each","Forsworn Focus : each","Antidote : each","Frostskin Potion : each","Arctic Potion : each","Scavenger's Balm : each","Vampirism Potion : each","Assassin's Tonic : each","Auric Bloom : each","Mirrorback Brew : each","Golem's Power : each","Guardian's Bulwark : each","Quietus : each","Midas Brew : each","Featherwalk Potion : each","Sanguiene Oath : each","Dance of the Undead : each","Gilded Transmutation : each","Cloudwalk Potion : each","Distilled Extract : each","Provocation Potion : each","Strigoi's Covenant : each","Death's Rally : each"],
      Armors: ["Cobalt Armor : each","Varax Armor : each","Glacial Armor : each","Deadrock Armor : each","Spectral Armor : each","Phantom Armor : each","Nightspun Armor : each"],
      Weapons: ["Sharper Mythan Sword : each","Cobalt Sword : each","Chaotic Mythan Sword : each","Varaxite Sword : each","Glacial Blade : each","Nature's Blade : each","Spectral Sword : each","Phantom Sword : each","Ancient Scimitar : each","Fire Staff : each","Ice Staff : each","Nature Staff : each","Cursed Staff : each","Elder Fire Staff : each","Elder Ice Staff : each","Elder Nature Staff : each","Elder Cursed Staff : each","Nightspun Staff : each"],
      Tools: ["Mythan Axe : each","Mythan Pickaxe : each","Mythan Rod : each","Mythan Secateurs : each","Cobalt Axe : each","Cobalt Pickaxe : each","Cobalt Rod : each","Cobalt Secateurs : each","Varaxite Axe : each","Varaxite Pickaxe : each","Varaxite Rod : each","Varaxite Secateurs : each","Magic Axe : each","Magic Pickaxe : each","Magic Rod : each","Bryomera Secateurs : each","Ancient Axe : each","Ancient Pickaxe : each","Ancient Rod : each"],
      BossParts: ["Balance fragment : each","Golemite Slab : 3m each","Golemite Shard : 4m each","Eye of Golemite : 2m each","Golemite Orb : 3m each","Golemite Artifact : 1.5m each","Dragon Scale : 15k each","Dragon Eye : 11m each","Dragon Claw : 16m each","Dragon Horn : 2m each","Slivers of Rage : 6m/100 each","Slivers of Corruption : 8.5m/100 each","Slivers of Disdain : 8m/100 each","Slivers of Torment : 8m/100 each","Leg of Nydarax : 48m each","Eye of Nydarax : 2m each","Gold Key : each","Mummy Bandage : each","Mummy Soul : each","Ancient Tablet : 5k each"],
      ...
      Others: ["Ruby : each","Sapphire : each","Emerald : each","Arosite : each","Sandstone Shield : each","Scorpion Shield : each","Deadrock Shield : each","Ancient Shield : each","Iron Spade : each","Crimsteel Spade : each","Mythan Spade : each","Golemite Spade : each","Ancient Spade : each","Saving Grace : each","Bat Amulet : each","Nature Amulet : each","Amulet of Focus : each","Prospector's Necklace : each","Ruby Necklace : each","Sapphire Necklace : each","Emerald Necklace : each","Arosite Necklace : each","Magnetite Necklace : each","Battle Necklace : each","Scorpion Gauntlets : each","Raptor Gloves : each","Desert Raptor Gloves : each","Ice Raptor Gloves : each","Cactus Gloves : each","Frozen Skull : each","Icy Right Half : each","Icy Left Half : each","Ring of Treasure : each","Nature Ring : each","Bat Ring : each","Ring of Might : each","Infernal Ring : each","Cactus Ring : each","Snake charm : each","Infernal Hammer : each","Ring of Violation : each","Pendant of Serenity : each","Inferno Tome : each","Consume Tome : each","Blizzard Tome : each","Torture Tome : each","Lollipop : each","Nydarax Teleport Scrool : each","Red Key : each","Blue Key  : each","Green Key : each","Mysterious Artifact : each","Key to 'Disdain' : each","Key to 'Rage' : each","Key to 'Torment' : each","Key to 'Corruption' : each",]
    };
