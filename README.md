...
<body>
  ...
  <script>
    ...
    const items = {
      Ores: ["Copper Ore : 400 each","Tin Ore : 400 each","Iron Ore : 800 each","Salt : 4k each","Coal : 3-4k each","Crimstell Ore : 3-4k each","Silver Ore : 4-5k each","Gold Ore : 3-4k each","Pink Salt : 7k each","Mythan Ore : 10-12k each","Sandstone : 10k each","Cobalt Ore : 12-14k each","Varaxium : 13-15k each","Black Salt : 10k each","Magic Ore : 4-4.5k each"],
