...
<body>
  ...
  <script>
    ...
    const items = {
      ...
      Fishes: ["Anchovies : each","Gold Fish : each","Mackerel : each","Squid : each","Sardine : each","Eel : each","Anglerfish : each","Trout : 10k each","Jellyfish : each","Bass : 20k each","Herringbone : each","Tuna : each","Lobster : each","Sea Turtle : each","Manta Ray : each","Shark : each","Orca : each","Giant Squid : each",],
      Baits: ["Earthworm : each","Iceworm : each","Corpseworm : each","Toxicworm : each","Sandworm : each","Beetle : 1k-2k each","Grasshopper : 3k-5k each","Wasp : 3k-4k each","Scallop : 7k-9k each",],
