...
<body>
  ...
  <script>
    ...
    const items = {
      ...
      Baits: ["Earthworm : 10 each","Iceworm : 20 each","Corpseworm : 30 each","Toxicworm : 40 each","Sandworm : 50 each","Beetle : 1k-2k each","Grasshopper : 3k-5k each","Wasp : 3k-4k each","Scallop : 7k-9k each",],
